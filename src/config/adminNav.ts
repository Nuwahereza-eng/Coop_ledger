...
import { LayoutDashboard, Users, Settings, ShieldAlert, History, Landmark, Edit3, Vote } from 'lucide-react';
...
export const adminNavItems: NavItem[] = [
  ...
  { href: '/admin/approve-loans', label: 'Loan Proposals', icon: Vote },
